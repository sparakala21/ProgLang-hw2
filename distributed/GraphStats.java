...
public class GraphStats extends UniversalActor  {
	...
	public class State extends UniversalActor .State {
		...
		public List merge(Object[] results, String outputFileA) {
			List BigMoney = new ArrayList();
			Map counts = new HashMap();
			Map degrees = new HashMap();
			for (int i = 0; i<results.length; ++i){
...
continue;				}
		...
		public void printAnswerA(List results, String outputFileA) {
			if (results==null||results.size()!=2) {{
				{
					// standardError<-println("Invalid input list")
					{
						Object _arguments[] = { "Invalid input list" };
						Message message = new Message( self, standardError, "println", _arguments, null, null );
						__messages.add( message );
					}
				}
